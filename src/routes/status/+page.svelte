<script lang="ts">
  ...
  <div class="content flex min-h-screen flex-col items-center p-8 text-white relative z-10">
    ...
    <div class="flex-1 w-full max-w-4xl flex items-center justify-center">
      <p class="text-gray-400 text-lg">This page is still under construction. Please check back later.</p>
    </div>
